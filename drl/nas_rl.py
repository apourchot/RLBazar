...
from drl.models import MetaActor, MetaActorv2, MetaActorv3, MetaActorMAB, CriticTD3 as Critic, MultiCriticTD3 as MultiCritic
...
class NASRL(object):
    ...
    def train(self, memory, n_iter, ops_mat):
        ...
        for _ in tqdm(range(n_iter)):
            ...
            # Compute actor loss
            actor_loss = -self.critic_t(states, self.actor(states, ops_mat))[0].mean()
...
class NASRLMAB(object):
    ...
    def __init__(self, state_dim, action_dim, max_action, args):
        ...
        # Actor stuff
        self.actor = MetaActorMAB(state_dim, action_dim, max_action, args)
        self.actor_t = MetaActorMAB(state_dim, action_dim, max_action, args)
        self.actor_t.load_state_dict(self.actor.state_dict())
        self.actor_opt = torch.optim.Adam(
            self.actor.parameters(), lr=args.actor_lr)
...
class NASReptiLeFull(object):
    ...
    def train(self, memory, n_iter, ops_mat):
        ...
        self.critic_t.load_state_dict(self.meta_critic.state_dict())
    ...
    def acc_meta_grad(self, grad):
        """
        Accumulate meta gradient and apply gradient descent every meta period accumulation
        """
        self.meta_cpt += 1
        self.meta_grad += grad
    ...
    def apply_meta_grad(self):
        """
        Do gradient descent on meta objective
        """
